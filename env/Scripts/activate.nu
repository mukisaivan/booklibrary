...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\MUKISA IVAN\PycharmProjects\software-development-project\env'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\MUKISA IVAN\PycharmProjects\software-development-project\env\Scripts\deactivate.nu'
